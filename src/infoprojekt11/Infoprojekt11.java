...
public class Infoprojekt11 {
    ...
    public static void main(String[] args) {
        ...
        s_i.mannschaft2  = mannschaft[(i+k[0])%(n-1)];
        s_i.mannschaft17 = mannschaft[(i-k[0])%(n-1)];
        s_i.mannschaft3  = mannschaft[(i+k[1])%(n-1)];
        s_i.mannschaft16 = mannschaft[(i-k[1])%(n-1)];
        s_i.mannschaft4  = mannschaft[(i+k[2])%(n-1)];
        s_i.mannschaft15 = mannschaft[(i-k[2])%(n-1)];
        s_i.mannschaft5  = mannschaft[(i+k[3])%(n-1)];
        s_i.mannschaft14 = mannschaft[(i-k[3])%(n-1)];
        s_i.mannschaft6  = mannschaft[(i+k[4])%(n-1)];
        s_i.mannschaft13 = mannschaft[(i-k[4])%(n-1)];
        s_i.mannschaft7  = mannschaft[(i+k[5])%(n-1)];
        s_i.mannschaft12 = mannschaft[(i-k[5])%(n-1)];
        s_i.mannschaft8  = mannschaft[(i+k[6])%(n-1)];
        s_i.mannschaft11 = mannschaft[(i-k[6])%(n-1)];
        s_i.mannschaft9  = mannschaft[(i+k[7])%(n-1)];
        s_i.mannschaft10 = mannschaft[(i-k[7])%(n-1)];    
